...
export const HeroSection = () => {
  ...
  return (
    <div className="relative container mx-auto min-h-[80vh] flex flex-col items-center justify-center py-16 md:py-24 rounded-3xl overflow-hidden">
      {/* Background gradient overlay */}
      <div className="absolute inset-0 bg-gray-50 dark:bg-gradient-to-br dark:from-orange-500/10 dark:via-gray-800/95 dark:to-gray-900/90"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center space-y-8">
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-gray-700 dark:text-white/80 max-w-2xl mx-auto">
          {language === 'es' 
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <ChevronDown className="h-8 w-8 text-gray-400 dark:text-white/50" />
        </div>
      </div>
