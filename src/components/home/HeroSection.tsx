...
export const HeroSection = () => {
  ...
  return (
    <div className="container mx-auto min-h-[80vh] flex flex-col items-center justify-center py-16 md:py-24 rounded-3xl overflow-hidden">
      {/* Background gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-background/95 to-background/90 dark:from-orange-500/10 dark:via-gray-800/95 dark:to-gray-900/90"></div>
