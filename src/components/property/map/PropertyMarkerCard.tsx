...
export const PropertyMarkerCard = ({ property }: PropertyMarkerCardProps) => {
  return `
    <div class="max-w-[220px] bg-white/95 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden border border-white/20">
      ...
      <div class="p-3">
        <h3 class="text-sm font-semibold text-gray-900 truncate leading-tight mb-1">${property.name}</h3>
        <p class="text-xs text-gray-600 truncate leading-tight mb-2">${property.address}</p>
        <div class="flex items-center justify-between">
          <span class="text-xs text-gray-500">${property.bedrooms}b ${property.bathrooms}ba</span>
